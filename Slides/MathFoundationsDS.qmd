---
title: "Mathematical Foundations of Data Science and Machine Learning"
jupyter: python3
---

## Mathematical Foundations of DS and ML

Welcome to DS722, Mathematical Foundations of DS and ML.
...
::: {.notes}
Consider a scenario where we are predicting whether a picture is cute/not cute.
...
* **OH:** W 9AM-12PM
* **Location:**  Check Piazza for location
...
- There are weekly problem sets with roughly 5-10 questions per assignment.
...
- There are 13 discussion sections that are held on Thursdays. 
...
- During the semester there will be 6 discussion quizzes consisting of 4 questions worth 10 points. 2 questions will be based on problems in the problem set. The other 2 questions will be unseen problems. 
...
Use the SCC through the [OnDemand](http://scc-ondemand1.bu.edu/) interface.
...
You are not prevented from using Generative AI tools to help with your homework. However, since you are tested on the material in discussions and exams, it is best practice to work on the problems yourselves first in order to better understand the material.
