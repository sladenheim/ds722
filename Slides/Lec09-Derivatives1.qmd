...
Let $k$ be an integer and let the function $f:\mathbb{R}\rightarrow \mathbb{R}$ be $k$ times differentiable at the point $c\in\mathbb{R}$. Then there exists a remainder function $r_{k}:\mathbb{R}\rightarrow \mathbb{R}$ such that
