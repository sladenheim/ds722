---
title: "More Linear Algebra, Orthogonality and Projections"
jupyter: python3
---
...
Recall that a matrix $Q\in\mathbb{R}^{m\times m}$ is symmetric if $Q=Q^{T}$.
...
Orthogonal matrices are an extremely important class of matrices.
...
# Plot the vector q_1 (u1)
plt.quiver(0, 0, u1[0], u1[1], angles='xy', scale_units='xy', scale=1, color='g', label='q_1')
