...
- $P(A\mid B)$ is called the posterior
- $P(A)$ is called the prior
- $P(B\mid A)$ is called the likelihood
- $P(B)$ total probability or evidence

This formula tells us that $P(A\mid B)\propto P(B\mid A)P(A)$.
...
:::: {.fragment}
In words, what does $P(A\mid B)$ represent?
::::
...
- $\small P(\text{Bowl 1})$ which is one bowl out of two, is  1/2.
- $\small P(\text{Vanilla} \vert \text{Bowl 1})$ which is 30 out of 40 cookies, is 3/4.
- $\small P(\text{Vanilla})$ is a little tougher. It's the combined probability of Vanillas from either bowl. What can we do?

::: {.notes}
$$\small \begin{align*}
 & P(\text{Vanilla})  = \\
 & = P(\text{Vanilla} \vert \text{Bowl 1})\;P(\text{Bowl 1}) +  P(\text{Vanilla} \vert \text{Bowl 2})P(\text{Bowl 2}) \\
& = (3/4)(1/2)+(1/2)(1/2) =5/8 
\end{align*}$$
:::
...
- $\small P(\text{Bowl 1}) = 1/2$,
- $\small P(\text{Vanilla} \vert \text{Bowl 1}) = 30/40$, and
- $\small P(\text{Vanilla}) = 5/8$,

we have

$$
\small \begin{align*}
P(\text{Bowl 1} \vert \text{Vanilla})\ & = \frac{P(\text{Vanilla} \vert \text{Bowl 1})P(\text{Bowl 1})}{P(\text{Vanilla})}\\
...
$$
\small P(H \,\vert\, D)\; =  \frac{P(D\,\vert\,H)P(H) \; }{P(D)}. 
$$
...
$$
\small P(D\,\vert\,\text{Bowl 1}) = \frac{30}{40} = 0.75.
$$
...
Hypothesis 1: The prize is behind door 1. What is $P(D\mid H_{1})$?

Hypothesis 2: The prize is behind door 2. What is $P(D\mid H_{2})$?

Hypothesis 3: The prize is behind door 3. $P(D\mid H_{3})$?
