...
::: {.notes}
Think of $E_{k+1}$ as an exponentially weighted moving average  of squared gradients. 

When the gradient has consistently small magnitudes, then the moving average is small, the denominator is small and we can take larger steps when the gradient is consistent.

When the gradient fluctuates or is large, then the weighted moving average is larger and we take smaller steps. Prevents overshooting or divergence.
:::
