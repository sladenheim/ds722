...
The following laws assume that $\lim_{x \to a} f(x)$ and $\lim_{x \to a} g(x)$ exist.

1. $\lim_{x \to a} [f(x) + g(x)] = \lim_{x \to a} f(x) + \lim_{x \to a} g(x)$
1. $\lim_{x \to a} [f(x) - g(x)] = \lim_{x \to a} f(x) - \lim_{x \to a} g(x)$
1. $\lim_{x \to a} [c \cdot f(x)] = c \cdot \lim_{x \to a} f(x)$
1. $\lim_{x \to a} [f(x) \cdot g(x)] = \lim_{x \to a} f(x) \cdot \lim_{x \to a} g(x)$
1. $\lim_{x \to a} \left[\frac{f(x)}{g(x)}\right] = \frac{\lim_{x \to a} f(x)}{\lim_{x \to a} g(x)}$ *provided* $\lim_{x \to a} g(x) \ne 0$

## Composite Limit Law

If $\lim_{x \to a} g(x) = L$ and $f$ is continuous at $L$ (i.e., $\lim_{x \to L} f(x) = f(L)$), then  
...
1. $\lim{x\rightarrow 0} (1+x)^{1/x} = e$
1. $\lim{x\rightarrow\infty} \left(1+\frac{1}{x}\right)^{x} = e$
...
- $a = 1, r = \frac{1}{2}$: $1 + \frac{1}{2} + \frac{1}{4} + \dots$
