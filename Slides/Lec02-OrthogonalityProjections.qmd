...
then $QQ^{T}$ is an orthogonal projector onto $\operatorname{range}(Q)$. As long as the columns of $Q$ are orthonormal any product of this form projects onto the column space of $Q$.
